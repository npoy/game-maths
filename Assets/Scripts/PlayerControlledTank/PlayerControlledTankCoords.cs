...
public class PlayerControlledTankCoords {

    public float x;
    public float y;
    public float z;

    public PlayerControlledTankCoords(float _X, float _Y)
    {
        x = _X;
        y = _Y;
        z = -1;
    ...
    public PlayerControlledTankCoords(float _X, float _Y, float _Z)
    {
        x = _X;
        y = _Y;
        z = _Z;
    ...
    public PlayerControlledTankCoords(Vector3 vecpos)
    {
        x = vecpos.x;
        y = vecpos.y;
        z = vecpos.z;
    ...
    static public void DrawLine(PlayerControlledTankCoords startPoint, PlayerControlledTankCoords endPoint, float width, Color colour)
    {
    ...
    static public void DrawPoint(PlayerControlledTankCoords position, float width, Color colour)
    {
