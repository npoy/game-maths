...
public class CoordsMovingTank {

    public float x;
    public float y;
    public float z;

    public CoordsMovingTank(float _X, float _Y)
    {
        x = _X;
        y = _Y;
        z = -1;
    ...
    public CoordsMovingTank(float _X, float _Y, float _Z)
    {
        x = _X;
        y = _Y;
        z = _Z;
    ...
    public CoordsMovingTank(Vector3 vecpos)
    {
        x = vecpos.x;
        y = vecpos.y;
        z = vecpos.z;
    ...
    static public void DrawLine(CoordsMovingTank startPoint, CoordsMovingTank endPoint, float width, Color colour)
    {
    ...
    static public void DrawPoint(CoordsMovingTank position, float width, Color colour)
    {
